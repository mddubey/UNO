...
public class PlayerTest {
    ...
    public void shouldBeAbleToAddACardInCardsList() {
        ...
        player.addCard(new Card(CardValue.EIGHT, CardColor.GREEN));

        List<Card> allCards = player.getAllCards();
        assertEquals(allCards.get(0), new Card(CardValue.EIGHT, CardColor.GREEN));
    }

    @Test
    public void shouldBeAbleToGetAllTheCardsPresentInList() {
        Player player = new Player("someone");
        player.addCard(new Card(CardValue.EIGHT, CardColor.YELLOW));
        player.addCard(new Card(CardValue.FIVE, CardColor.RED));
    ...
    public void shouldBeAbleToPlayACard() {
        Player player = new Player("someone");
        Card card = new Card(CardValue.FIVE, CardColor.BLUE);
        player.addCard(card);
